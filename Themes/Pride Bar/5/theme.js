...
ctx.shadowBlur = 32;
ctx.fillText('$CITY$', 186, 800, 1000);
...
ctx.shadowColor = "rgba(0,0,0,0.1)";
ctx.shadowBlur = 32;
ctx.fillText('$TEMPS$', 1100, 815, 1000);
...
ctx.shadowBlur = 32;
ctx.fillText('$GREETING$', 88, 934, 1000);
...
ctx.shadowColor = "rgba(0,0,0,0.53)";
ctx.shadowBlur = 32;
ctx.fillText('$STRING2$', 88, 1076, 1100);